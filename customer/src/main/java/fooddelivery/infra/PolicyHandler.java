...
public class PolicyHandler {
    ...
    @StreamListener(
        ...
        condition = "headers['type']=='CouponGenerated'"
    )
    public void wheneverCouponGenerated_SendNotification(
        @Payload CouponGenerated couponGenerated
    ) {
    ...
    public void wheneverDeliveryStarted_SendNotification(
    ...
    public void wheneverOrderPlaced_SendNotification(
    ...
    public void wheneverOrderCancelled_SendNotification(
    ...
    public void wheneverDeliveryCancelled_SendNotification(
